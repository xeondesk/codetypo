...
from ._version import __version__ as version  # type: ignore[import-not-found]
...
_builtin_dictionaries = (
    ...
    (
        "code",
        "for words from code and/or mathematics that are likely to be codetypo in other contexts (such as uint)",  # noqa: E501
        "_code",
        None,
        None,
        None,
    ...
    (
        "names",
        "for valid proper names that might be codetypo",
        "_names",
        None,
        None,
        None,
...
def parse_options(
    ...
    parser.add_argument(
        ...
        "words to be ignored by codetypo. Files must contain "
    ...
    parser.add_argument(
        ...
        "by codetypo. Words are case sensitive based on "
        "how they are written in the dictionary file.",
    )
    parser.add_argument(
        ...
        metavar="WORDS",
        help="comma-separated list of words to be ignored "
        "by codetypo in URIs and emails only. Words are "
    ...
    parser.add_argument(
        ...
        "codetypo to skip .eps and .txt files, "
    ...
    parser.add_argument(
        ...
        "file. This can slow down codetypo, but is more "
    ...
    # Load config files and look for ``codetypo`` options.
    cfg_files = ["setup.cfg", ".codetyporc"]
    if options.config:
    ...
    if toml_files:
        ...
        if tomllib is not None:
            for toml_file in toml_files:
                ...
                if "codetypo" in data:
                    data["codetypo"] = _toml_to_parseconfig(data["codetypo"])
